          ...
          return (
            ...
            >
              ...
              <div
                ...
                transition-all duration-300 delay-150 hover:scale-[1.02]
                hover:shadow-lg dark:hover:shadow-[0_0_35px_rgba(34,197,94,0.6)]
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300 transition-colors duration-300">{edu.school}</p>
                    <p className="text-xs text-gray-500 mt-1">{edu.date}</p>
                  </div>
                </div>

                {/* Grade */}
                <p className="text-gray-800 dark:text-gray-300 transition-colors duration-300 font-medium mb-2">
                  Grade: {edu.grade}
                </p>
